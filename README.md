...
A15. Quelle commande observe en temps réel la formation des adjacences OSPF ?  (B)
a) show ip ospf adj
b) debug ip ospf adj ----
c) trace ip ospf
d) monitor ospf neighbor

A16. Que représente l'aire 0 dans OSPF ?(B)
...
B1. Dans router ospf 1, que représente le « 1 » ?  (C)
a) L'area ID
